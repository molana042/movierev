        ...
        <div class="item">
            ...
            <div class="jumbotron">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Rate Movies</h1>
                        <p>Buatlah akun untuk menilai film-film favorit Anda.</p>
                        <p><a class="btn btn-lg btn-info" href="registration.php" role="button">Daftar Sekarang</a></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="jumbotron">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Read Reviews</h1>
                        <p>Jelajahi semua ulasan kami dan temukan lebih banyak informasi tentang apa yang orang lain pikirkan tentang film-film favorit Anda!</p>
                        <p><a class="btn btn-lg btn-info" href="reviews.php" role="button">Lihat Review &raquo;</a></p>
                    </div>
                </div>
            </div>
        </div>
